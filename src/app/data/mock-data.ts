...
export interface Creator {
  ...
  aboutMe: string;
  showcaseImages: string[];
  recentCollabs: { id: string; title: string; role: string; thumbnail: string; collaborators: string[] }[];
...
export const projects: Project[] = [
  {
    ...
    thumbnail: imgThumbnailContainer,
    listedBy: '@MQ Media',
    timeAgo: '5 days ago',
    tags: [
  ...
  },
  {
    ...
    thumbnail: imgThumbnailContainer1,
    listedBy: '@MQ Media',
    timeAgo: '5 days ago',
    tags: [
...
export const creators: Creator[] = [
  {
    ...
    recentCollabs: [
      { id: 'rc-1', title: 'Project Gnosis', role: 'Illustrator', thumbnail: 'https://images.unsplash.com/photo-1695152979271-a8927a3b2700?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3YXRlcmNvbG9yJTIwcG9ydHJhaXQlMjBwYWludGluZyUyMGFydHxlbnwxfHx8fDE3NzUzNjEzODR8MA&ixlib=rb-4.1.0&q=80&w=1080', collaborators: ['@MQ Media', '@nova_writes'] },
    ...
    testimonials: [
      ...
      { id: 't-2', author: '@nova_writes', text: 'Working with kitsune_art was a fantastic experience. They brought our characters to life in ways I never imagined. Very responsive and professional.', avatar: '' },
  ...
  },
  {
    ...
    avatar: '',
    bio: 'Narrative designer and screenwriter looking for a team to build an interactive fiction project. Experienced with Twine and ink.',
    portfolioImages: [
    ...
    socials: [
      { platform: 'Twitter', handle: '@nova_writes', url: '#' },
      { platform: 'Bluesky', handle: '@nova_writes', url: '#' },
    ],
    maxProjects: 2,
    aboutMe: 'Narrative designer and screenwriter looking for a team to build an interactive fiction project. Experienced with Twine and ink. I bring stories to life through branching narratives and compelling character arcs.',
    showcaseImages: [
      'https://images.unsplash.com/photo-1726332365444-76095559c75c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25jZXB0JTIwYXJ0JTIwbGFuZHNjYXBlJTIwZGlnaXRhbHxlbnwxfHx8fDE3NzUzNTU2NjR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    ...
    recentCollabs: [
      { id: 'rc-3', title: 'Echoes of Dawn', role: 'Writer', thumbnail: 'https://images.unsplash.com/photo-1769203905592-75f6902dc651?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXJrJTIwZmFudGFzeSUyMGdvdGhpYyUyMGlsbHVzdHJhdGlvbnxlbnwxfHx8fDE3NzUzNTU2NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080', collaborators: ['@kitsune_art'] },
    ],
    testimonials: [
      { id: 't-4', author: '@kitsune_art', text: 'Nova is a talented writer with incredible storytelling skills. Our collaboration was seamless!', avatar: '' },
    ],
    portfolioLinks: [
  ...
  },
  {
    ...
    maxProjects: null,
    aboutMe: 'Game developer specializing in Unity and Unreal Engine. Currently focused on personal projects and not taking new collaborations.',
    showcaseImages: [
  ...
  },
  {
    ...
    recentCollabs: [
      { id: 'rc-4', title: 'The Monsters Within', role: 'Voice Actor', thumbnail: 'https://images.unsplash.com/photo-1695152979271-a8927a3b2700?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3YXRlcmNvbG9yJTIwcG9ydHJhaXQlMjBwYWludGluZyUyMGFydHxlbnwxfHx8fDE3NzUzNjEzODR8MA&ixlib=rb-4.1.0&q=80&w=1080', collaborators: ['@MQ Media'] },
    ],
    testimonials: [
  ...
  },
  {
    ...
    maxProjects: null,
    aboutMe: 'Composer and sound designer creating atmospheric soundscapes. Currently on a creative break but will be back soon.',
    showcaseImages: [
      'https://images.unsplash.com/photo-1759171052927-83f3b3a72b2b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwaXhlbCUyMGFydCUyMHJldHJvJTIwZ2FtZXxlbnwxfHx8fDE3NzUzNTU2NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
      'https://images.unsplash.com/photo-1647727416391-0bc8f5bda78e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHwzZCUyMHJlbmRlciUyMGNoYXJhY3RlciUyMGRlc2lnbnxlbnwxfHx8fDE3NzUzNTU2NjV8MA&ixlib=rb-4.1.0&q=80&w=1080',
    ],
